...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product">
      ...
      <h3 style="color:#337ab7">Price: $ ${product.price}</h3>
      <h5>Average Rating : <span id="${product.id}"></span> ( ${product.rating.rate} )</h5>
...
/*=========================== function for dynamic star-rating ===========================*/

const dynamicRating = (ratingId, stars) => {
  let star = Math.round(stars);
  let i = parseInt(ratingId);
  if (star === 1) {
    document.getElementById(i).innerHTML = '<i class="fa fa-star" style="color:#337ab7"></i><i class="fa fa-star-o" style="color:#337ab7"></i><i class="fa fa-star-o" style="color:#337ab7"></i><i class="fa fa-star-o" style="color:#337ab7"></i><i class="fa fa-star-o" style="color:#337ab7"></i>';
  }
  else if (star === 2) {
    document.getElementById(i).innerHTML = '<i class="fa fa-star" style="color:#337ab7"></i><i class="fa fa-star" style="color:#337ab7"></i><i class="fa fa-star-o" style="color:#337ab7"></i><i class="fa fa-star-o" style="color:#337ab7"></i><i class="fa fa-star-o" style="color:#337ab7"></i>';
  }
  else if (star === 3) {
    document.getElementById(i).innerHTML = '<i class="fa fa-star" style="color:#337ab7"></i><i class="fa fa-star" style="color:#337ab7"></i><i class="fa fa-star" style="color:#337ab7"></i><i class="fa fa-star-o" style="color:#337ab7"></i><i class="fa fa-star-o" style="color:#337ab7"></i>';
  }
  else if (star === 4) {
    document.getElementById(i).innerHTML = '<i class="fa fa-star" style="color:#337ab7"></i><i class="fa fa-star" style="color:#337ab7"></i><i class="fa fa-star" style="color:#337ab7"></i><i class="fa fa-star" style="color:#337ab7"></i><i class="fa fa-star-o" style="color:#337ab7"></i>';
  }
  else if (star === 5) {
    document.getElementById(i).innerHTML = '<i class="fa fa-star" style="color:#337ab7"></i><i class="fa fa-star" style="color:#337ab7"></i><i class="fa fa-star" style="color:#337ab7"></i><i class="fa fa-star" style="color:#337ab7"></i><i class="fa fa-star" style="color:#337ab7"></i>';
  }
}
...
/*======================= upcomming (alert) features message function =======================*/
const alertMessage = () => {
...
=========================== https://assignment-debugging.netlify.app/ ============================
